ORCHESTRATOR_AGENT_INSTRUCTION = """ 
    ...
    <instructions>
        ...
        - Stricly make sure to follow below steps sequentially (collect entities and tool use) to provide best travel locations to user.
        ...
        - When you generate the final recommendations, make sure to consider nearby locations in given Travel Destination and user interests activities.
